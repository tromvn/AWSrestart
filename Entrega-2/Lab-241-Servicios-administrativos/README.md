...
Como en labs anteriores, descargo desde "details" la ip y el archivo .pem, le coloco el nombre del lab: lab241.pem y accedo por SSH con el comando: 

``$ ssh -i lab241.pem ec2-user@ip-from-details``
