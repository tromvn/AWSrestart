...
![](src/1-obteniendo-credenciales.png)
...
![](src/4-algunos-problemas-de-terminal-y-horas-locales.png)
![](src/5-calendarios.png)

![](src/6-comando-id.png)
...
![](src/7-history-sin-todos-los-comandos.png)  


Tuve que probar reverse en local
![](src/8-comprobando-reverse-en-local.png)
